...
class PessoaController {
    ...
    static async restautaPessoa(req, res) {
        const { id } = req.params
        try {
            ...
            return res.status(200).json({ message: `Pessoa com id: ${id} restaurada` })
        } catch (error) {
            return res.status(500).json(error.message)
        }
    }
    ...
    static async removeMatricula(req, res) {
        ...
        try {
            ...
            return res.status(200).json({ message: `Matricula com id: ${matriculaId} deletada` })
        } catch (error) {
            return res.status(500).json(error.message)
        }
    }
